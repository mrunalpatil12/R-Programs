...
class(mix)  #Highest priority goes to char datatype
...
seq(1,50,by=3) #Writing by is optional
seq(1,10) #If you don't mention step value it will consider as 1
...
x[c(-1,-4)]
x
#We can't give the sequence in -minus sign i.e -1:-4
x[1] = 3
