...
plot(airquality$Wind, type= "l") #If we are not given any value then default value is p
...
barplot(airquality$Ozone, 
        ...
        col= 'blue',
        horiz=F,
        axes=T)#If we don't mention horiz then default we get vertical bar graph as default is set at F
